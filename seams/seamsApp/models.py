...
class CustomAccountManager(BaseUserManager):
    ...
    def create_user(self, email, user_name, name, password, **other_fields):
        ...
        elif other_fields.get('is_student') is True:
            other_fields.setdefault('is_student', True)
        else:
            pass
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def create_user(self, email, user_name, name, password, **other_fields):
        ...
        if other_fields.get('is_teacher') is True:
            ...
            pass
        user = self.model(email=email, user_name=user_name, name=name, password=password, **other_fields)
        user.set_password(password)
        user.save()
        return user
