...
class UserAdminConfig(UserAdmin):
    ...
    ordering = ('-start_date',)
    list_display = ('email', 'user_name', 'name', 'is_active', 'is_staff', 'is_teacher','is_student', 'is_superuser','approved')
    ...
    fieldsets = (
        ...
        ('Permissions', {
            "fields": (
                ('is_active', 'is_staff', 'is_teacher','is_student',  'is_superuser', 'approved')
            ),
        }),
        ('Personal', {
            "fields": (
    ...
    add_fieldsets = (
        (None, {
            'classes':('wide',),
            'fields':('email', 'user_name', 'name', 'password1', 'password2', 'is_active', 'is_staff', 'is_teacher','is_student', 'is_superuser')
            }
        ),
    )
